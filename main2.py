...
fig.add_trace(go.Scatter(x =[first_stdev_end, first_stdev_end], y=[0, 0.17], mode = "lines", name = "ST_DEV 1 END"))
fig.show()
...
fig.add_trace(go.Scatter(x =[first_stdev_end, first_stdev_end], y=[0, 0.17], mode = "lines", name = "ST_DEV 1 END"))
fig.add_trace(go.Scatter(x =[second_stdev_end, second_stdev_end], y=[0, 0.17], mode = "lines", name = "ST_DEV 2 END"))
fig.show()
